// image::./sources/2.0.0/images/figure-s129-logo.svg[S129_logo,248,120]

= IHO S-129 Under Keel Clearance Management

image:https://github.com/metanorma/iho-s-129/actions/workflows/generate.yml/badge.svg["Build Status", link="https://github.com/metanorma/iho-s-129/actions/workflows/generate.yml"]

This document is available in its rendered forms here:

* https://metanorma.github.io/iho-s-129/[IHO S-129 (HTML)]

== Purpose

This is the IHO repository for developing the next edition of
the S-129 Under Keel Clearance Management.
...
This repository contains the source files of S-129 standard, including:

* S-129 Ed 2.0.0 - Under Keel Clearance Management
...
`sources/`::
source of the S-129 documents and models
